...
static unsigned int sleep_gpio_table[][3] =
{
...
#elif defined(CONFIG_LATIN_ARIES_TV)  //HS.yi: Define the LATIN Sleep GPIO:2010.08.17 
	...
	{S5PV210_GPJ3(2), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//_3_GPIO_TOUCH_EN - BLN FIXED
